...
var calendar = (function (Tag) {
    ...
    var getViewItems = function (y, m, ctx) {
        var _a = ctx.config, singleView = _a.singleView, minDate = _a.minDate, maxDate = _a.maxDate;
        var viewItems = [{ year: y, month: m }], n;
        if (singleView) {
    ...
    var initProps = function (ctx) {
        ...
        var firstDay = config.firstDay, _a = config.rangeLimit, rangeLimit = _a === void 0 ? [] : _a, minDate = config.minDate, maxDate = config.maxDate, isRange = config.isRange, isMultiple = config.isMultiple, weekMode = config.weekMode, singleView = config.singleView;
        ...
        var numberOfMonths = config.numberOfMonths;
        //多日历视图
        if (numberOfMonths) {
    ...
    var getDefaultYearAndMonth = function (ctx) {
        var selectDatesFormat = ctx.state.selectDatesFormat;
        var _a = ctx.config, defaultDate = _a.defaultDate, singleView = _a.singleView, minDate = _a.minDate, maxDate = _a.maxDate;
        var year, month;
...
var version = 'v1.0.0';
var utils = { addDays: addDays, cloneDate: cloneDate, cloneAsDate: cloneAsDate, registerChildComponent: registerChildComponent, subtractDays: subtractDays, isAfterDate: isAfterDate, monthDiff: monthDiff };
//注册子组件
