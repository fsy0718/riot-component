...
declare namespace riot {
    ...
    interface BracketsInterface {
        (reOrIdx: RegExp) : RegExp
        (reOrIdx: number) : string | RegExp 
    }

    interface CheckInterface {
        isSVGTag: (name:string)=> boolean,
    ...
    interface MkElInterface {
        (name: string) : HTMLElement,
        (name: string, isSvg: boolean) : SVGSVGElement,
    }
    ...
    interface DomInterface {
        ...
        mkEl: MkElInterface,
        getOuterHTML: (el: HTMLElement|SVGElement) => string,
        setInnerHTML: (container: HTMLElement|SVGElement, html:string)=> void,
        remAttr: (dom: HTMLElement|SVGElement, name: string)=> void,
        getAttr: (dom: HTMLElement|SVGElement, name: string)=> string,
        setAttr: (dom:HTMLElement|SVGElement, name: string, val: string)=> void,
        safeInsert: (dom: HTMLElement, curr: HTMLElement, next: HTMLElement)=> void,
        walkAttrs: (html:string, fn: Function)=> void,
        walkNodes: (dom: HTMLElement, fn: Function, context: HTMLElement)=> void
    }

    interface MiscInterface {
        each: (list:Array, fn: Function)=>Array,
        contains:(array: Array, item: any)=> number,
        toCamel:(str: string)=> string,
        startsWith: (str: string, value: string)=> boolean,
        defineProperty: (el: Object, key: string, value: any, options: Object)=> Object
        extend: (src: Object, ...rest: Object[])=> Object
    }
    ...
    interface TagsUtilInterface {
        getTag: (dom: HTMLElement)=> string,
        inheritFrom: (target: Object, propsInSyncWithParent: Array)=> void,
        moveChildTag: (tagName: string, newPos: number)=> void,
        initChildTag: (child: Object, opts: Object, innerHTML: string, parent: Tag)=> Tag,
        getImmediateCustomParentTag: (tag: Tag, )=> Tag,
        unmountAll: (expressions: Array)=> void,
        getTagName: (dom: HTMLElement, skipDataIs: boolean)=> string,
        cleanUpData: (data: Object)=> Object,
        arrayishAdd: (obj: Object, key: string, value: Object, ensureArray: boolean)=> void,
        arrayishRemove: (obj: Object, key: string, value: Object, ensureArray:boolean)=> void,
        isInStub: (dom: HTMLElement)=> boolean,
        mountTo: (root: HTMLElement, tagName: string, opts: Object, ctx: Object)=> Tag,
        makeVirtual: (src: HTMLElement, target: HTMLElement)=> void,
        moveVirtual: (src: HTMLElement, target: HTMLElement)=> void,
        selectTags: (tags: Tag[])=> string
    }

    interface Util {
        tmpl: (str: any, data: any) => any,
        brackets: BracketsInterface,
        check: CheckInterface,
        dom: DomInterface,
        misc: MiscInterface,
        styleManager: StyleManagerInterface,
        styleNode: HTMLStyleElement,
        tags: TagsUtilInterface,
        vdom: Tag[]
    }
    ...
    function mixin(mixinName: string, mixinObject: TagMixin, g: boolean): void;
